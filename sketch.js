...
var storySprite, storySpriteImg;
...
function preload() {
    ...
    storySpriteImg = loadImage("storyDialogueImg.png");
}
...
function setup() {
    ...
    storySprite = createSprite(windowWidth/2,windowHeight/2);
    storySprite.addImage(storySpriteImg);
    storySprite.visible = false;
    storySprite.scale = 1.55;
}
...
if(bluePlayer.collide(ground)){
  ...
  //  console.log(gameState);
    bomb1.x = windowWidth;
    bomb1.y = Math.round(random(100,800));
    bomb1.velocityX = -(Math.random(2,6));
    bomb2.x = windowWidth;
    bomb2.y = Math.round(random(100,800));
    bomb2.velocityX = -(Math.random(2,6));
    bomb3.x = windowWidth;
    bomb3.y = Math.round(random(100,800));
    bomb3.velocityX = -(Math.random(2,6));
    bomb4.x = windowWidth;
    bomb4.y = Math.round(random(100,800));
    bomb4.velocityX = -(Math.random(2,6));
...
brick.depth = 0;
bluePlayer.depth = 0;
treeVillain.visible = true;

storySprite.length = windowHeight;
}
